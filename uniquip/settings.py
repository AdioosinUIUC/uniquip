"""
Django settings for uniquip project.
...
SECRET_KEY = 'django-insecure-tn11w6(smmvvv6x%frz$a3+ex!mq69b4b#kz63c&$u@bu(q&2h'
...
WSGI_APPLICATION = 'uniquip.wsgi.application'
